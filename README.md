...
```c
#if KEEMASH_MESH_CORE_VERSION != 0x00040100UL
#error "firmware requires keemash_mesh_core 0.4.1"
#endif
```

Use a fixed commit or tag such as `v0.4.1` when integrating the component into
