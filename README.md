...
```c
#if KEEMASH_MESH_CORE_VERSION != 0x00030300UL
#error "firmware requires keemash_mesh_core 0.3.3"
#endif
```

Use a fixed commit or tag such as `v0.3.3` when integrating the component into
